<div class = "d-flex">
    {{-- Edit Button --}}
    <button class = "editBtn btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" data-id = "{{ $invoice->id }}">
    ...
    {{-- Delete Button --}}
    <button class = "btn btn-icon btn-bg-light btn-active-color-primary btn-sm delete me-1" data-id = "{{ $invoice->id }}">
    <span   class = "svg-icon svg-icon-3">
