    ...
    <div class="card mb-5 mb-xl-8">
        ...
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bolder fs-3 mb-1">{{__('admin.Invoices')}}</span>
            </h3>
            <div class="card-toolbar">
                <a id="addBtn" href="{{ route('invoices.create') }}" class="btn btn-sm btn-light-primary">
...
@section('js')
    ...
    @include('Admin.layouts.inc.ajax',['url'=>'invoices'])
