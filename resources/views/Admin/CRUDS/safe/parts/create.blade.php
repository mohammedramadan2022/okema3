<!--begin::Form-->
<form id="form" enctype="multipart/form-data" method="POST" action="{{ route('safes.store') }}">
    @csrf
    <div class="row g-4">
        ...
        <div class="d-flex flex-column mb-7 fv-row col-sm-6">
            <label class="d-flex align-items-center fs-6 fw-bold form-label mb-2">
                <span class="required mr-1">{{ __('admin.current_balance') }}<span class="red-star">*</span></span>
            </label>
            <input
                required
                type="number"
