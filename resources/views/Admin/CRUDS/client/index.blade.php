    ...
    <div class="card mb-5 mb-xl-8">
        ...
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bolder fs-3 mb-1">{{ __('admin.Clients') }}</span>
            </h3>
                ...
                <table id="table"
                    ...
                    <thead>
                        <tr class="fw-bolder text-muted bg-light">
                            <th>#</th>
                            <th>{{ __('admin.name') }}</th>
                            <th>{{ __('admin.attention') }}</th>
                            <th>{{ __('admin.email') }}</th>
                            <th>{{ __('admin.contact') }}</th>
                            <th>{{ __('admin.company_name') }}</th>
                            <th>{{ __('admin.invoice_start') }}</th>
                            <th>{{ __('admin.quote_start') }}</th>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg mw-650px">
            ...
            <div class="modal-content" id="modalContent">
                ...
                <div class="modal-header">
                    <!--begin::Modal title-->
                    <h2><span id="operationType"></span> {{ __('admin.Client') }} </h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
