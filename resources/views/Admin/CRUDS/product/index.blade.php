    ...
    <div class="card mb-5 mb-xl-8">
        ...
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bolder fs-3 mb-1">{{__('admin.Products')}}</span>
            </h3>
            ...
            <div class="table-responsive">
                <table id="table" class="table align-middle gs-0 gy-4 table table-bordered dt-responsive nowrap table-striped align-middle">
                    ...
                    <tr class="fw-bolder text-muted bg-light">
                        ...
                        <th>{{__('admin.name')}}</th>
                        <th>{{__('admin.code')}}</th>
                        <th>{{__('admin.original_code')}}</th>
                        <th>{{__('admin.Category')}}</th>
                        <th>{{__('admin.buy_price')}}</th>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg mw-650px">
            ...
            <div class="modal-content" id="modalContent">
                ...
                <div class="modal-header">
                    <!--begin::Modal title-->
                    <h2><span id="operationType"></span> {{__('admin.Product')}} </h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
...
@section('js')
    <script>
        var columns = [
            ...
            {data: 'name', name: 'name'},
            {data: 'code', name: 'code'},
            {data: 'original_code', name: 'original_code' ,orderable: true, searchable: true},
        ...
        $(document).on('change', '.activeBtn', function () {
            ...
            $.ajax({
                type: 'GET',
                url: "{{route('admin.active.product')}}",
                data: {
                    id: id,
                },
