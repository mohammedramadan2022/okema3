...
<form id="form" enctype="multipart/form-data" method="POST" action="{{ route('countries.update', $country->id) }}">
    ...
    <div class="row g-4">
        ...
        <div class="d-flex flex-column mb-7 fv-row col-sm-6">
            ...
            <input required type="text" class="form-control form-control-solid" placeholder="" name="name" value="{{ $country->name }}"/>
        </div>
        ...
        <div class="d-flex flex-column mb-7 fv-row col-sm-6">
            ...
            <select class="form-control" id="is_active" name="is_active">
                ...
                <option value="1" {{$country->is_active == 1 ? 'checked' :''}}>{{__('admin.Active')}}</option>
                <option value="0" {{$country->is_active == 0 ? 'checked' :''}}>{{__('admin.Not Active')}}</option>
        ...
        <div class="d-flex flex-column mb-7 fv-row col-sm-6">
            ...
            <input required type="text" class="form-control form-control-solid" placeholder="" name="country_code" value="{{$country->country_code}}"/>
        </div>
